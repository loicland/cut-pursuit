...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    const Lipschtype Ltype = (mxGetNumberOfElements(prhs[6]) == 1) ? SCAL : DIAG;
    ...
    if (mxIsDouble(prhs[0])){
        ...
        const double *L = (double*) mxGetData(prhs[6]);
        ...
        PFDR_graph_quadratic_d1_bounds<double>(V, E, N, X, Y, A, Eu, Ev, La_d1, \
                                    Bnd[0], Bnd[1], Ltype, L, rho, condMin, \
        ...
        const float *L = (float*) mxGetData(prhs[6]);
        ...
        PFDR_graph_quadratic_d1_bounds<float>(V, E, N, X, Y, A, Eu, Ev, La_d1, \
                                    Bnd[0], Bnd[1], Ltype, L, rho, condMin, \
                                    difRcd, difTol, itMax, it, Obj, Dif, verbose);
                                   /* 22 arguments */
    }
