...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        PFDR_graph_quadratic_d1_bounds<double>(V, E, -V, X, AtY, AtA, Eu, Ev, La_d1, \
        ...
        PFDR_graph_quadratic_d1_bounds<float>(V, E, -V, X, AtY, AtA, Eu, Ev, La_d1, \
                                Bnd[0], Bnd[1], Ltype, L, rho, condMin, \
                                difRcd, difTol, itMax, it, Obj, Dif, verbose);
                                /* 22 arguments */
    }
    ...
    La_d1[0], Bnd[0], rho, condMin, difRcd, \
