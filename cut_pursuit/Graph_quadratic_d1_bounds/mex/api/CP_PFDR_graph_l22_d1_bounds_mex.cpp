/*==================================================================
 * [Cv, rX, CP_it, Time, Obj, Dif] = CP_PFDR_graph_l22_d1_bounds_mex(Y, La_l2, Eu, Ev, La_d1, Bnd, CP_difTol, CP_itMax, PFDR_rho, PFDR_condMin, PFDR_difRcd, PFDR_difTol, PFDR_itMax, verbose)
 * 
 *  Hugo Raguet 2016
 *================================================================*/
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        CP_PFDR_graph_quadratic_d1_bounds<double>(V, E, 0, &rV, Cv, &rX, Y, La_l2, \
        ...
        CP_PFDR_graph_quadratic_d1_bounds<float>(V, E, 0, &rV, Cv, &rX, Y, La_l2, \
                                Eu, Ev, La_d1, Bnd[0], Bnd[1], CP_difTol, \
                                CP_itMax, CP_it, PFDR_rho, PFDR_condMin, \
                                PFDR_difRcd, PFDR_difTol, PFDR_itMax, \
                                Time, Obj, Dif, verbose, NULL);
    ...
    V, E, Y[0], La_l2[0], Eu[0], Ev[0], La_d1[0], Bnd[0], Cv[0], \
