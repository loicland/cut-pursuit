...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        CP_PFDR_graph_quadratic_d1_bounds<double>(V, E, -V, &rV, Cv, &rX, AtY, AtA, \
        ...
        CP_PFDR_graph_quadratic_d1_bounds<float>(V, E, -V, &rV, Cv, &rX, AtY, AtA, \
                                Eu, Ev, La_d1, Bnd[0], Bnd[1], CP_difTol, \
                                CP_itMax, CP_it, PFDR_rho, PFDR_condMin, \
                                PFDR_difRcd, PFDR_difTol, PFDR_itMax, \
                                Time, Obj, Dif, verbose, NULL);
    ...
    V, E, N, AtY[0], AtA[0], Eu[0], Ev[0], La_d1[0], Bnd[0], Cv[0], \
