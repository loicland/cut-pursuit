...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        PFDR_graph_quadratic_d1_l1<double>(V, E, N, X, Y, A, Eu, Ev, La_d1, \
        ...
        PFDR_graph_quadratic_d1_l1<float>(V, E, N, X, Y, A, Eu, Ev, La_d1, \
                                    La_l1, pos, Ltype, L, rho, condMin, \
                                    difRcd, difTol, itMax, it, Obj, Dif, verbose);
                                   /* 22 arguments */
    }
    ...
    V, E, N, Y[0], A[0], X[0], Eu[0], Ev[0], La_d1[0], (void*) La_l1, Ltype, L[0], rho, \
