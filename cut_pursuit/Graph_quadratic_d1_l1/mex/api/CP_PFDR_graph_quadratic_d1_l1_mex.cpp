...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    if (mxIsDouble(prhs[0])){
        ...
        CP_PFDR_graph_quadratic_d1_l1<double>(V, E, N, &rV, Cv, &rX, Y, A, \
        ...
        CP_PFDR_graph_quadratic_d1_l1<float>(V, E, N, &rV, Cv, &rX, Y, A, \
                                Eu, Ev, La_d1, La_l1, pos, CP_difTol, \
                                CP_itMax, CP_it, PFDR_rho, PFDR_condMin, \
                                PFDR_difRcd, PFDR_difTol, PFDR_itMax, \
                                Time, Obj, Dif, verbose, NULL);
    ...
    V, E, N, Y[0], A[0], Eu[0], Ev[0], La_d1[0], La_l1[0], Cv[0], \
